...
add_action('wp_footer', function () {
    ...
    // check if Checkout.com is active and bail if not
    $active_gateways = af_active_gateways();

    if ($active_gateways && !in_array('wc_checkout_com_cards', $active_gateways)) :
        return;
    endif;
    ...
    if (is_checkout()) {
         ...
         * RECAPTCHA ON SUBMIT
         **********************/
        if (isset($_POST['rcv2-checkout-com-submit'])) :
        ...
        <!-- recaptcha modal -->
        <div id="rcv2-checkout-com-overlay" style="display: none;"></div>

        <div id="rcv2-checkout-com-modal" style="display: none;">
            ...
            <form id="rcv2-ccom-af-form" method="post" action="">
                ...
                <input id="rcv2-checkout-com-submit" class="button button-primary" name="rcv2-checkout-com-submit" type="submit" value="<?php echo __('Submit', 'woocommerce'); ?>">
            </form>
        </div>
                ...
                if (url_found > 0) {
                    ...
                    if (response_json.result === 'failure' && ccom_found > 0) {
                        ...
                        $.post('<?php echo admin_url('admin-ajax.php') ?>', data, function(response) {
                            ...
                            if (response === 'trigger_recaptcha') {
                                $('#rcv2-checkout-com-overlay, #rcv2-checkout-com-modal').show();
                                return
                            }
        ...
        <style>
            ...
            input#rcv2-checkout-com-submit {
                width: 100%;
                margin-bottom: 0;
                font-size: 18px;
                border-radius: 2px;
...
function ccom_fraud_check_ajax() {
    ...
    if ($_SESSION['ccom_checkout_attempts'] > 3) :
        wp_send_json('trigger_recaptcha');
        wp_die();
    endif;
